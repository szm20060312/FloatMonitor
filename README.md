...
Mac 菜单栏系统监控工具，实时显示 CPU 与内存占用，点击弹出详细面板查看 GPU、网络等数据。UI 采用 macOS 26 "液态玻璃"设计风格。
...
```bash
# 克隆仓库
git clone https://github.com/szm20060312/cpu_mem_tool.git
cd cpu_mem_tool
